# Single Colab cell (copy/paste): launch latest telemonitoring app from repo + public URL
...
if url:
    print("✅ App live URL:")
    print(url)
    print("\nOpen and scroll to: 🧭 Longitudinal Patient Analysis")
else:
    print("⚠️ Could not detect tunnel URL yet. Keep cell running and retry.")
